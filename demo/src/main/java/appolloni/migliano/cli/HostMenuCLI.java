...
public class HostMenuCLI {
    ...
    private final ControllerGestioneStrutture controllerCreazioneStrutture;
    private final ControllerRecensioni controllerRecensioni;

    public HostMenuCLI(BeanUtenti utente) {
        this.scanner = new Scanner(System.in);
        this.beanUtente = utente;
        this.controllerCreazioneStrutture = new ControllerGestioneStrutture();
    ...
    public void start() {
        ...
        while (!back) {
            ...
            try {
                ...
                BeanStruttura struttura = controllerCreazioneStrutture.visualizzaStrutturaHost(beanUtente.getEmail());
    ...
    private void gestioneCambioFoto() {
        ...
        if (file.exists() && file.isFile()) {
            try {
                ...
                controllerCreazioneStrutture.cambiaFoto(beanUtente.getEmail(), file.getName());
