...
public class ChatCLI {
    ...
    private BeanUtenti utenteLoggato;
    private BeanGruppo gruppoCorrente;
    ...
    private void mostraMessaggi() throws SQLException, Exception {
        try{
    ...
    private void inviaMessaggioUI() throws SQLException, Exception {
